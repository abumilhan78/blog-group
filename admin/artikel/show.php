        ...
        <div class="page">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tampilan Artikel</li>
                </ol>
            </nav>
            <!-- end breadcumb -->
                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                          <div class="row no-gutters">
                            <div class="col-md-4">
                              <img src="img/<?= $foto; ?>" class="card-img" alt="...">
                            </div>
                            <div class="col-md-8">
                              <div class="card-body">
                                <h5 class="card-title"><?= $judul; ?></h5>
                                <p class="card-text"><?= $konten; ?></p>
                                <p class="card-text"><small class="text-muted"><?= date_format($tgl, 'F d, Y'); ?></small>&nbsp;<small></small></p>
                              </div>
                            </div>
                          </div>
                        </div>
